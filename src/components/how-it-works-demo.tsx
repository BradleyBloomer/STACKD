  ...
  return (
    ...
    >
      <div className="sticky top-0 flex min-h-screen items-center overflow-hidden px-6 py-20 md:px-10">
        <div className="mx-auto grid w-full max-w-6xl items-center gap-16 lg:grid-cols-[minmax(0,320px)_1fr]">
          <div className="mx-auto w-full max-w-[280px]">
            <div className="relative aspect-[9/16] w-full rounded-[2rem] border border-white/15 bg-[#08090a] p-3">
              <div className="relative h-full w-full overflow-hidden rounded-[1.5rem] bg-charcoal">
                {reduceMotion ? (
                  screens[activeStep]
                ) : (
          ...
          <div>
            ...
            <ul className="mt-12 flex flex-col gap-5">
              {STEPS.map((step, i) => (
                <li
                  key={step}
                  className={`border-l-2 pl-5 font-display text-xl transition-colors duration-300 sm:text-2xl ${
                    i === activeStep
